  ...
  const handleAccept = () => {
    if (accepted && participantSigned && dateSigned) {
      ...
      toast({
        ...
        description: "Please accept the invitation and complete all signature checkboxes to proceed.",
        variant: "destructive",
      });
    }
  };
    ...
    <div className="min-h-screen bg-black">
      <header className="bg-black text-white p-4 shadow-md border-b border-brand-yellow/30">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-brand-yellow">Urban Infrastructure Tokenization Survey</h1>
        </div>
      </header>
      ...
      <main className="container mx-auto py-8 px-4 bg-gradient-to-br from-black via-black to-[#333300]">
        <div className="max-w-4xl mx-auto bg-black/70 p-6 rounded-lg border border-brand-yellow/20 shadow-lg">
          ...
          <div className="overflow-y-auto max-h-[60vh] p-4 bg-black border border-brand-yellow/10 rounded-md mb-6 text-brand-yellow/90">
            ...
            <p className="mb-4">
              This questionnaire, which will be available from May the 10 2025 to July the 10, 2025, will take about 15-20 minutes to complete and utilizes a 5-point Likert-type scale, using an online google doc questionnaire form. Its purpose is to identify the challenges and opportunities associated with implementing tokenization in the management of urban infrastructure.
            </p>
            
            <p className="mb-4">
              Participation is completely voluntary, and you can opt out of the study at any time without any negative consequences. If you decide to withdraw, any information provided by you will be discarded from the study.
            </p>
            
            <p className="mb-4">
              Rest assured that no personal or company information will be collected during this process. Your responses will be kept confidential and will only be used for research purposes. While there are no immediate benefits for you, your input will help advance sustainable urban infrastructure in South Africa.
            </p>
            
            <p className="mb-4">
              By completing the questionnaire, you indicate your voluntary agreement to participate in this research under the specified terms.
            </p>
            
            <p className="mb-4">
              Thank you for considering being part of this study. Your involvement is highly valued.
            </p>
            ...
            <p className="mb-4">For any questions, concerns, or additional information, please contact the below:</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p><strong>Researcher:</strong> Naeem Razak</p>
                <p><strong>Email:</strong> Naeemrazak96@gmail.com</p>
                <p><strong>Phone:</strong> 061 810 9145</p>
              </div>
              <div>
                <p><strong>Supervisor:</strong> Prof Trynos Gumbo</p>
                <p><strong>Email:</strong> tgumbo@uj.ac.za</p>
                <p><strong>Phone:</strong> 011 559 6318</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 mb-6">
            ...
            <Label 
              ...
              className="text-brand-yellow cursor-pointer"
            >
              I have read and agree to participate in this research under the specified terms
            </Label>
          </div>
