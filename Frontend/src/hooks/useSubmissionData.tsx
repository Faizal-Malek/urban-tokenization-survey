    ...
    const fetchSubmissions = async () => {
      try {
        ...
        const response = await fetch(
          "https://urban-tokenization-survey.onrender.com/api/admin/questionnaires",
          {
        ...
        const formattedSubmissions = data.submissions.map(
          (item: any, index: number) => {
            ...
            return {
              ...
              yearsOfExperience:
                ...
                responses.yearsOfExperience ||
                "Not specified",
              blockchainFamiliarity:
                knowledge.blockchainFamiliarity ||
                responses.blockchainFamiliarity ||
                "Not specified",
              participatedProjects: responses.participatedProjects || "No",
              adoptionLikelihood:
                future.adoptionLikelihood ||
                responses.adoptionLikelihood ||
                "Not specified",
              stakeholderViews:
                stakeholders.stakeholderViews ||
                responses.stakeholderViews ||
                "Not specified"
            };
          }
        );
